...
/**
 * Вітаю! Ви відкрили секретний додатковий матеріал, де будуть відповіді на ваші запитання "Як це зробити?"
 * І додаткові пояснення щодо багатьох моментів:)
 *
 * А також ще одне завданнячко, яке буде досить простим.
 *
 * Умови задачі:
 * Створіть, будь ласка, три змінні типу String, які будуть приймати від користувача 3 слова відповідно.
 * Після того як користувач введе 3 сл  ова, він має отримати у вивід повноцінний рядок з цих слів, але без роздільників.
 ...
 *
 *
 * P.S. Колись ця чорнетка мала бути насправді лекцію номер один;)
 */
